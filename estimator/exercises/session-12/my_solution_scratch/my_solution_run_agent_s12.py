...
# This file lives at estimator/exercises/session-12/my_solution_scratch/my_solution_run_agent_s12.py. Add estimator/ to the path so
...
from my_solution_agent_schemas import AgentRunResult, SearchBudgetsArgs  # noqa: E402
from my_agent_loop_s12 import agent_loop_run  # noqa: E402
...
async def _main_async(args: argparse.Namespace) -> int:
    ...
    print(f"Used store to search for references: {'stub' if args.stub else 'retrieve() pipeline'}")
